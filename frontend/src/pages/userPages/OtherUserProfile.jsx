                            ...
                            <div className="bg-white shadow-md rounded-lg">
                                ...
                                <div className="p-4">
                                    ...
                                    {loggeduserid !== userData._id &&  
                                        <div>
                                            {!isFollowing ? (
                                                <button type="button" onClick={() => { handleFollow(userData._id) }} className="h-8 ml-[950px] -mb-6 text-green-700 hover:text-white border border-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-3  text-center me-2  dark:border-green-500 dark:text-green-500 dark:hover:text-white dark:hover:bg-green-600 dark:focus:ring-green-800">Follow</button>
                                            ) : (
                                                <button type="button" onClick={() => { handleUnfollow(userData._id) }} className="h-8 ml-[940px] -mb-6 text-red-700 hover:text-white border border-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-3 text-center me-2  dark:border-red-500 dark:text-red-500 dark:hover:text-white dark:hover:bg-red-600 dark:focus:ring-red-900">Unfollow</button>
                                            )}
                                        </div>
                                    }
